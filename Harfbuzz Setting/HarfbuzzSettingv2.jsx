try {
    ...
    if (!changeSetting) {
        ...
        // Step 5: Force Recompose Text Frames by Making a Minor Edit
        // This step forces InDesign to recompose all text frames in the active document by making a minor, temporary edit to each text frame.
